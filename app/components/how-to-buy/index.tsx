  ...
  const slides = [
    {
      ...
      description:
        'Install a Defi wallet such as Best Wallet or Trust Wallet for ETH or USDT ERC-20 purchase. Connect it to our secure presale widget to buy and track your $RISE token holdings.',
      subtitle: '1',
    },
    {
      title: 'Have ETH or USDT ERC-20',
      description:
        'To purchase $RISE tokens you need to have Ethereum (ETH), Tether ERC-20 (USDT) in your wallet. Deposit crypto to your wallet or purchase crypto directly in your wallet. ',
      subtitle: '2',
    },
    {
      title: 'Swap',
      description:
        'Now you can swap your ETH or USDT for $RISE tokens. Select how much you would like to spend and you will see how many tokens you will receive. Make sure you leave a little ETH for gas fees (network transaction fee). ',
      subtitle: '3',
    },
    {
