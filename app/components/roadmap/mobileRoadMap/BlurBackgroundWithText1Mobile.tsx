          ...
          <div className="flex gap-2 pl-1 pb-[6px]">
            <div>
              <Image
                src={round}
                alt="round"
                className="xs:w-5 xs:h-5 xxs:w-3 xxs:h-3 mini:w-3 mini:h-3 "
              />
            </div>
            <p className="font-cinzel  font-[600]    xs:text-[14.45px] xxs:ext-[8.39px] mini:text-[8.39px]   text-transparent bg-clip-text bg-gradient-to-b from-[#E4D9BD] via-[#E4D9BD] via-0% to-[#AA8246] to-100%">
